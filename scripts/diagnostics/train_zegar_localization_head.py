...
# (22.09) decode_topk_peaks / decode_topk_peaks_real_t MOVED to src/peak_decoding.py so the
# production report can use them without importing from scripts/diagnostics/. Re-exported here
# unchanged — every existing `from train_zegar_localization_head import decode_topk_peaks`
# keeps working, and there is exactly one implementation.
from src.peak_decoding import (  # noqa: E402,F401
    DEFAULT_MIN_GAP_T, decode_topk_peaks, decode_topk_peaks_real_t,
)
